...
class StarshipController extends Controller {
  constructor() {
    const router = () => {
      ...
      r.post('/delete', Permissions.Write, Validation.CheckItemIdIsProvided, this.RemoveStarship);
      return r;
    };
    super(router);
  ...
  private async RemoveItem(req: DeleteItemsRequest, res: Response) {
    ...
    const removers = [StarshipRepository.RemoveFilms, StarshipRepository.RemovePilots];
  ...
  private async Update(req: UpdateEntityRequest<IStarshipEntity>, res: Response) {
